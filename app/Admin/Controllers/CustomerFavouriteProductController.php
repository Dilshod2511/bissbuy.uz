...
class CustomerFavouriteProductController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Customer Favourite Products';
    ...
    {
        $grid = new Grid(new CustomerFavouriteProduct());
    ...
    {
        $show = new Show(CustomerFavouriteProduct::findOrFail($id));
    ...
    {
        $form = new Form(new CustomerFavouriteProduct());
