...
class CustomerViewedProductController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Customer Viewed Products';
    ...
    {
        $grid = new Grid(new CustomerViewedProduct());
    ...
    {
        $show = new Show(CustomerViewedProduct::findOrFail($id));
    ...
    {
        $form = new Form(new CustomerViewedProduct());
