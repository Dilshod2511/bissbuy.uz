...
class CategoryBannerController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Category Banner';
    ...
    {
        $grid = new Grid(new CategoryBanner());
        ...
        $grid->column('category_banner_image', __('Category Banner Image'))->image();
    ...
    {
        $show = new Show(CategoryBanner::findOrFail($id));

        $show->field('id', __('Id'));
        $show->field('category_id', __('Category id'));
        $show->field('category_banner_image', __('Category banner image'));
    ...
    {
        $form = new Form(new CategoryBanner());
        $category = Category::pluck('category_name', 'id');


        $form->select('category_id', __('Category'))->options($category)->required();
        $form->image('category_banner_image', __('Category Banner Image'))->move('category_banner_images')->uniqueName()->required();
